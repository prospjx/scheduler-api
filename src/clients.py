...
async def fetch_single_course(
    client: httpx.AsyncClient, course_id: str
) -> dict[str, Any]:
...
async def analyze_schedule_with_ai(
    ...
    payload = {"student_profile": student_profile, "schedule": schedule}
